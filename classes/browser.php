...
class Browser{
    ...
    */
	public static function detect($user_agent)
	{
		...
		if(strpos($user_agent, self::$first))
		{
			$addOn = self::$first;
		}
		if(strpos($user_agent, self::$second))
		{
			$addOn = self::$second;
		}    
		if(strpos($user_agent, self::$third))
		{
			$addOn = self::$third;
		}   
		...
		if(strpos($user_agent, self::$fifth))
		{
			$addOn = self::$fifth;
		}    
		if(strpos($user_agent, 'MSIE') or strpos($user_agent, 'Trident'))
		{
			$addOn = self::$sixth;
		}

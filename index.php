...
/////////////////////////////////////LOZNIKE////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////
// RANDOM CITKA LOZINKA
  /*
  *  @param: $length // ako se ne unese onda se podrazumeva na 10
  *  @return: $pwd
  */
  function randomReadablePasword($length=10){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
// PROVERA SIGURNOSTI LOZINKE
  /*
  *  @param: $string // lozinka ciju sigurnost treba proveriti
  *  @return: $strength // broj od 0% do 100% sa dve decimale
  */
  function passwordStrength($string){
    $h = 0;
    $size = strlen($string);
    if($size>=9 and preg_match('/^[a-zA-Z0-9._]+$/', string) ){ // bar devet karaktera lozinke i alfanumericka
...
////////////////////////////////////////////////////////////////////////////////////////////
// PROVERA SIGURNOSTI LOZINKE - SUPER
  /*
  *  @param: $username
  *  @param: $password
  *  @return: $strength // broj od 0% do 100% sa dve decimale
  */
  function passwordStrength_super($username, $password){
    $triggerUserIsPass = false;
    $h = 0;
    $size = strlen($password);
    if($size>=9 and preg_match('/^[a-zA-Z0-9._]+$/', string) ){ // bar devet karaktera lozinke i alfanumericka
      $nizUsername = explode(".",$username);
      foreach($nizUsername as $podatak){
        //echo $podatak. "<br/>";
        if(strpos($password, $podatak) !== false){ // uporedjuje username sa passwordom
          //echo "Sadrži " .$podatak. "!"."<br/>";
          $triggerUserIsPass = true;
        }
      }

      if($triggerUserIsPass){ // ako password ima deo username-a
        $strength = 0;
      }else{ // ako je password dobar
    ...
    }else{ // ima manje od devet karaktera
      $strength = 0;
    }
  return round($strength,2);
  }

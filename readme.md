...
* Math: even_or_odd method modified, static keyword added to percentage method. New method iterate added. Iterate method returns value and variable is set to private.
